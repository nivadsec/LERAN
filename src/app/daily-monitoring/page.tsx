            ...
            <CardContent className="space-y-6">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                 ...
                 <FormField name="satisfaction" control={form.control} render={({ field }) => (
                    <FormItem><FormLabel>رضایت درونی: {field.value}</FormLabel><FormControl><Slider dir="ltr" value={[field.value || 3]} onValueChange={(v) => field.onChange(v[0])} max-h
-h
-h
h
-h
...
h
h
-h` | `max={5} min={1} step={1} /></FormControl></FormItem>
                 )} />
