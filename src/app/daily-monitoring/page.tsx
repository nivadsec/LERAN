          ...
          <Card>
            ...
            <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField name="dayEndTime" control={form.control} render={({ field }) => (
                        <FormItem><FormLabel className="flex items-center justify-end gap-2"><Clock className="h-4 w-4"/>ساعت پایان روز</FormLabel><FormControl><Input dir="ltr" placeholder="HH:MM" {...field} /></FormControl><FormMessage /></FormItem>
                    )} />
                </div>
